...
question_mark_img = pygame.transform.scale(question_mark_img, TILE_SIZE)
...
# def font
FONT_GAME_STATUS = pygame.font.SysFont('Bauhaus 93', TILE_WIDTH//5)
FONT_SCORE = pygame.font.SysFont('Bauhaus 93', TILE_HEIGHT//2)
FONT_LEVEL = pygame.font.SysFont('Bauhaus 93', TILE_HEIGHT//3)
# set window size
